    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{url('dashboard/messages')}}">Exams</a></li>
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-12 pb-3">
                            ...
                            <form action="{{url("dashboard/messages/response/$message->id")}}" method="post" enctype="multipart/form-data">
                                @csrf
