    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                ...
                <div>
                    <button class="main-button icon-button pull-left">{{__('web.startExamBtn')}}</button>
                </div>
            </div>
            <!-- /main blog -->
            ...
            <div id="aside" class="col-md-3">
                ...
                <!-- exam details widget -->
                <ul class="list-group">
                    <li class="list-group-item">{{__('web.skill')}} : programming</li>
                    <li class="list-group-item">{{__('web.questions')}} : 20</li>
                    <li class="list-group-item">{{__('web.duration')}} : 30 {{__('web.mins')}}</li>
